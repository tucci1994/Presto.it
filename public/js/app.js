...
function buildURI() {
  var selectedCategoryId = getSelectedChild('#filters-container');
  var selectedOrder = getSelectedChild('#order-container');
  var selectedPrice = getSelectedChild('#price-container');
